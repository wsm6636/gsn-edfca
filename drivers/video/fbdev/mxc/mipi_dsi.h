...
#ifdef CONFIG_FB_MXC_EK79007_WVGA_SYNC_PANEL 
void mipid_ek79007_get_lcd_videomode(struct fb_videomode **mode, int *size,
		struct mipi_lcd_config **data);
int mipid_ek79007_lcd_setup(struct mipi_dsi_info *);
#endif

#ifndef CONFIG_FB_MXC_EK79007_WVGA_SYNC_PANEL 
   #error "Please configure MIPI LCD panel ICs of EK79007, we cannot find one!"
#endif
/*
