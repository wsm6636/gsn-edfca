...
/* current used bandwidth partitions */
	uint32_t		used_bw_partitions;//BW_bitmap
	/*bandwidth partition status */
    raw_spinlock_t		bw_lock;
	pid_t		bw2taskmap[MAX_BANDWIDTH_PARTITIONS];//BWtoTask_map
