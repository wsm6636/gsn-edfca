...
edt_ft5x06_ts_get_parameters(struct edt_ft5x06_ts_data *tsdata)
{
	...
	tsdata->num_x = FT5X06_X; //edt_ft5x06_register_read(tsdata, reg_addr->reg_num_x);
	tsdata->num_y = FT5X06_Y; //edt_ft5x06_register_read(tsdata, reg_addr->reg_num_y);
}
